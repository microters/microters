export const acronymToolSteps = {
  title: "How to Use Acronym Generator Tools?",
  description: "Using this tool is easy and takes just three steps:",
  steps: [
    {
      id: 1,
      title: "Step 1: Add Your Topic or Paragraphs",
      description: "Enter your word, topic, or detailed context into the input field. This can be a single word or a more complex idea. The tool uses this input to craft a fitting acronym."
    },
    {
      id: 2,
      title: "Step 2: Select Your Desired Tone",
      description: "Choose your preferred tone from the dropdown menu. Whether you need something professional, creative, or humorous, you can tailor the tone to match your needs."
    },
    {
      id: 3,
      title: "Step 3: Select Your Preferred Language",
      description: "Pick from over 100 available languages. Once chosen, hit the “Generate” button, and your acronym will be ready in moments!"
    }
  ]
};
...
export const googleKeywordToolsSteps = {
  title: "How to Use Google Auto Suggest Keyword Tools?",
  description: "Using Google Auto Suggest Keyword Tools is simple and effective. Here’s how to get started:",
  steps: [
    {
      id: 1,
      title: "Step 1: Enter Your Keyword Idea",
      description: "Type a keyword or phrase related to your topic into the tool’s search bar."
    },
    {
      id: 2,
      title: "Step 2: Review Suggestions",
      description: "Explore the list of auto-suggested keywords generated by the tool."
    },
    {
      id: 3,
      title: "Step 3: Export and Organize Keywords",
      description: "Download the suggestions and group them using a keyword clustering tool for easier content planning."
    }
  ]
};