  ...
  return (
    <main>
      ...
      <PageHeader
        ...
        description="This page will help you know all the legal information you should know about Microters."
      />
      ...
      <section className="w-full py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-gray-600 text-base lg:text-lg leading-relaxed space-y-6">
            <p>Welcome to Microters</p>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of Microters Website, located at{" "}
              <Link
                href="https://microters.com"
            ...
            <p>
              ...
              to use Microters if you do not agree to take all of the terms and
            ...
            <p>
              ...
              subject to, prevailing law of Bangladesh. Any use of the above
            ...
            <p>
              We employ the use of cookies. By accessing Microters, you agreed
              to use cookies in agreement with the Microters Privacy Policy.
            </p>
            <p>
              Most interactive websites use cookies to let us retrieve the
              user’s details for each visit. Cookies are used by our Microters
            ...
            <p>
              Unless otherwise stated, Microters and/or its licensors own the
              intellectual property rights for all material on Microters. All
              intellectual property rights are reserved. You may access this
              from Microters for your own personal use subjected to restrictions
              set in these terms and conditions.
            </p>
            <p>You must not:</p>
            <ul className="list-disc list-inside space-y-2 pl-4">
              <li>Republish material from Microters</li>
              <li>Sell, rent or sub-license material from Microters</li>
              <li>Reproduce, duplicate or copy material from Microters</li>
              <li>Redistribute content from Microters</li>
            </ul>
            ...
            <p>
              ...
              Microters does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of Microters, its agents and/or affiliates.
              ...
              laws, Microters shall not be liable for the Comments or for any
            ...
            <p>
              Microters reserves the right to monitor all Comments and to remove
            ...
            <p className="mt-4">
              You hereby grant Microters a non-exclusive license to use,
            ...
            <p className="mt-4">
              ...
              Microters; and (d) the link is in the context of general resource
              information.
            </p>
            <p>
            ...
            <p>
              ...
              by sending an e-mail to Microters. Please include your name, your
            ...
            <p className="mt-4">
              No use of Microters logo or other artwork will be allowed for
