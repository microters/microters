...
// 1. Define Default Content (so it works if no props are passed)
const defaultTitle = (
  <>
    Explore, <span style={{ color: "var(--color-primary)" }}>Create,</span>
    <br />
    and{" "}
    <span style={{ color: "var(--color-primary)" }}>Grow Online!</span>
  </>
);

const defaultDescription =
  "Why invest in digital marketing campaigns if you can't reach your potential customers? Be it Google's #1 page or getting the right leads – every single step taken in designing your marketing strategy counts. And Microters is here to help.";
    ...
    >
      ...
      <div className="px-5">
        <div className="container relative z-10">
          <div>
            {/* 3. Use the dynamic title prop here */}
            <h1
              className={`
                font-extrabold mb-4 leading-none
                text-4xl sm:text-6xl lg:text-7xl 
                ${isInnerPage ? "xl:text-[82px]" : "xl:text-[112px]"} 
              `}
            ...
            {/* 4. Use the dynamic description prop here */}
            <p
