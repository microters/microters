...
const defaultDescription = "Ready to kick start your new online venture? Before we get started, let's set some realistic expectations for what you can get from our eCommerce SEO services for new businesses.";
const StarIcon = () => (
  <svg
            ...
            {timelineItems.map((item, index) => (
              ...
              >
                ...
                <div className="absolute -top-[70px] left-1/2 -translate-x-1/2 z-10 hidden lg:flex items-center justify-center w-[60px] h-[60px]">
                  ...
                  {/* Pulse */}
                  <div className="absolute w-5 h-5 bg-[#f35d36] rounded-full -z-10 animate-pulse-border group-hover:hidden"></div>
                </div>
                ...
                <div className="bg-white absolute -top-[30px] left-1/2 -translate-x-1/2 z-30 hidden lg:flex items-center justify-center w-[60px] h-[60px] opacity-0 scale-0 transition-all duration-300 group-hover:opacity-100 group-hover:scale-100">
                   <div className="p-1.5 rounded-full outline outline-[#FDDFD7] outline-offset-4">
