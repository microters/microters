...
const ProjectsSection = () => {
    ...
    const TEXT_COLOR_META = '#eaebef'; 

    return (
        <section 
            className="relative bg-[#192138] text-white overflow-hidden px-5 py-16 lg:py-[100px]" 
        >
            {/* --- Large Background SVG Shape --- */}
             <div
            ...
            <div className="container relative z-10">
                ...
                <h2 className="text-4xl md:text-5xl lg:text-[72px] font-extrabold mb-4 leading-tight text-white">
                    <strong className="font-extrabold">Watch Projects</strong> for<br/>
                    Who Believed Us
                </h2>
                {/* Sub-Text */}
                <div className="max-w-4xl mb-10">
                    <p className="text-lg lg:text-[22px]" style={{ color: TEXT_COLOR_META }}>
