    ...
    async (data) => {
      ...
      try {
        ...
        setSubmitMessage({
          type: "error",
          message:
            "Could not send message. Please check your connection or try again later.",
        });
      }
    },
    [reset, setValue],
  ...
  return (
          ...
          <div className="w-full lg:w-3/5 p-8 lg:p-12">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className={labelClasses}>
                    First Name <span className="text-[#f35d36]">*</span>
                  </label>
                  <Controller
                    name="firstName"
                    control={control}
                ...
                <div>
                  <label className={labelClasses}>
                    Last Name <span className="text-[#f35d36]">*</span>
                  </label>
                  <Controller
                    name="lastName"
                    control={control}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className={labelClasses}>
                    Website URL <span className="text-[#f35d36]">*</span>
                  </label>
                  <Controller
                    name="website"
                    control={control}
                ...
                <div>
                  <label className={labelClasses}>
                    Job Title <span className="text-[#f35d36]">*</span>
                  </label>
                  <Controller
                    name="jobTitle"
                    control={control}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className={labelClasses}>
                    Work Email <span className="text-[#f35d36]">*</span>
                  </label>
                  <Controller
                    name="email"
                    control={control}
                ...
                <div>
                  <label className={labelClasses}>
                    Phone Number <span className="text-[#f35d36]">*</span>
                  </label>
                  <Controller
                    name="phone"
                    control={control}
              ...
              <div>
                <label className={labelClasses}>
                  Your Needs <span className="text-[#f35d36]">*</span>
                </label>
                <Controller
                  name="needs"
                  control={control}
                  ...
                  render={({ field }) => (
                    <select {...field} className={inputClasses}>
                      ...
                      <option value="Need More Organic Traffic">
                        Need More Organic Traffic
                      </option>
                      <option value="Need More Customer">
                        Need More Customer
                      </option>
                ...
                />
                {errors.needs && (
                  <p className={errorClasses}>{errors.needs.message}</p>
                )}
              </div>
              ...
              <div>
                <label className={labelClasses}>
                  How can we help you? <span className="text-[#f35d36]">*</span>
                </label>
                <Controller
                  name="message"
                  control={control}
              ...
              <div className="pt-2">
                ...
                />
                {errors.captchaToken && (
                  <p className={errorClasses}>{errors.captchaToken.message}</p>
                )}
              </div>
              ...
              <div className="pt-4">
                <button
                  ...
                  className={`
      bg-[#f35d36] hover:bg-[#d64d29] text-white font-bold text-lg py-4 px-10 rounded-lg 
    ...
    `}
          ...
          <div className="w-full lg:w-2/5 bg-[#29375d] p-8 lg:p-12 text-white flex flex-col justify-between">
            <div>
              <h4 className="text-3xl font-bold mb-6 border-l-4 border-[#f35d36] pl-4">
                Contact Us
              </h4>
              <p className="text-[#bfc3cf] mb-8 text-lg leading-relaxed">
                Ready to elevate your project? Contact us for tailored solutions
              ...
              <div className="space-y-4 mb-12">
                <a
                  ...
                  className="flex items-center gap-4 text-[#bfc3cf] hover:text-white transition-colors group"
                >
              ...
              <h4 className="text-2xl font-bold mb-8 border-l-4 border-[#f35d36] pl-4">
                Visit Us
              </h4>
              <div className="space-y-4 mb-12">
                <div className="flex items-start gap-4 text-[#bfc3cf]">
                  ...
                  <p className="leading-relaxed">
                    ...
                    Khan Zaman Tower (5th Floor), Holding No – 684/617, Jhautola
                    3500 Comilla.
                  </p>
                </div>
                <div className="flex items-start gap-4 text-[#bfc3cf]">
