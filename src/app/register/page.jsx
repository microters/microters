      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg border border-gray-100">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4">
            ...
            {/* Name Field */}
            <div>
              <label className="block text-sm font-medium text-[#212c4a]">Full Name</label>
              <input
                type="text"
            ...
            {/* Email Field */}
            <div>
              <label className="block text-sm font-medium text-[#212c4a]">Email address</label>
              <input
                type="email"
                {...register("email", { 
            ...
            {/* Password Field */}
            <div>
              <label className="block text-sm font-medium text-[#212c4a]">Password</label>
              <input
                type="password"
                {...register("password", { 
                ...
                className={`mt-1 block w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-[#f35d36] focus:border-[#f35d36] sm:text-sm ${errors.password ? 'border-red-500' : 'border-gray-300'}`}
              />
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/login" className="font-medium text-[#f35d36] hover:text-orange-600">
              Sign in instead
            </Link>
          </p>
        </div>
